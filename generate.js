...
// 1. DAFTAR FILE PENDUKUNG (Termasuk Semua Gambar Preview Anda)
const filesToCopy = [
    'index.html', 
    'robots.txt',
    'vercel.json',
...
let sitemapEntries = '';
const baseUrl = 'https://menudigital.guidify.app';
...
console.log(`✨ Sukses! 465 Halaman Menu Digital sudah siap.`);